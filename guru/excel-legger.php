...
<body style="font-family: Times !important;">
	<main style="font-family: Times !important;font-size: 13px !important;">
		<div class="container-fluid">
			<div class="panel panel-default"  style="width: 3800px !important;">
				<div class="panel-heading">
					<strong style="font-size: 14px !important;">LEGGER NILAI </strong>
				</div>
				<div class="panel-body" style="font-size: 13px !important;">
					<table class="table" style="width: 720px !important;font-family: Times !important;font-size: 13px !important;">
						<tr>
							<td colspan="2">Nama Kelas</td>
							<td>: 
							<?php
								if($kls==10){
									echo "X ";
					...
					<table id="data" class="table table-responsive table-hover table-bordered" style="width:3700px !important;font-size: 14px;font-family: Arial !important;border-collapse: collapse;" border="1" cellspacing="0">
						<thead  style="font-size: 14px;font-family: Arial !important;">
							<tr>
								<th rowspan="4" style="width: 20px !important;">No.</th>
						...
						<tbody>
							...
							<tr>
								...
								?>
								<td class="ctr" style="text-align: center;"><?php if($rapa->p_angka != NULL) echo $rapa->p_angka; else echo "0"; ?></td> <!-- angka pth -->
								<td class="ctr" style="text-align: center;"><?php if($rapa->p_predikat != NULL) echo $rapa->p_predikat; else echo "0"; ?></td> <!-- pred pth -->
								<td class="ctr" style="text-align: center;"><?php if($rapa->k_angka != NULL) echo $rapa->k_angka; else echo "0"; ?></td> <!-- angka pth -->
								<td class="ctr" style="text-align: center;"><?php if($rapa->k_predikat != NULL) echo $rapa->k_predikat; else echo "0"; ?></td> <!-- pred pth -->
								<?php endforeach; ?>
								<?php
								...
								?>
								<td class="ctr" style="text-align: center;"><?php if($rapb->p_angka != NULL) echo $rapb->p_angka; else echo "0"; ?></td> <!-- angka pth -->
								<td class="ctr" style="text-align: center;"><?php if($rapb->p_predikat != NULL) echo $rapb->p_predikat; else echo "0"; ?></td> <!-- pred pth -->
								<td class="ctr" style="text-align: center;"><?php if($rapb->k_angka != NULL) echo $rapb->k_angka; else echo "0"; ?></td> <!-- angka pth -->
								<td class="ctr" style="text-align: center;"><?php if($rapb->k_predikat != NULL) echo $rapb->k_predikat; else echo "0"; ?></td> <!-- pred pth -->
								<?php endforeach; ?>
								<?php
								...
								?>
								<td class="ctr" style="text-align: center;"><?php if($rapc->p_angka != NULL) echo $rapb->p_angka; else echo "0"; ?></td> <!-- angka pth -->
								<td class="ctr" style="text-align: center;"><?php if($rapc->p_predikat != NULL) echo $rapb->p_predikat; else echo "0"; ?></td> <!-- pred pth -->
								<td class="ctr" style="text-align: center;"><?php if($rapc->k_angka != NULL) echo $rapb->k_angka; else echo "0"; ?></td> <!-- angka pth -->
								<td class="ctr" style="text-align: center;"><?php if($rapc->k_predikat != NULL) echo $rapb->k_predikat; else echo "0"; ?></td> <!-- pred pth -->
								<?php endforeach; ?>
							</tr>
							<?php endwhile; ?>
						</tbody>
...
header("Content-Disposition: attachment;filename=LEGGER NILAI ".$rombel.".xls");
?>