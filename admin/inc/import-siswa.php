		...
		<div class="col-md-8">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<center>
						<a href="<?=base('admin/download/file/sample_siswa.xlsx');?>" class="btn btn-success">Download Template</a>
						<a href="<?=base('admin/siswa');?>" class="btn btn-primary">Kembali</a>
					</center>
					<br>
		...
		if (in_array($realtype, $listext)) {
			...
			if ($move) {
				...
				for ($i=2; $i <= $lastRow; $i++) :
					...
					$ins = insert('tbl_siswa', "id, nis, nisn, nama, kelas, rombel, jk", "NULL, '$nis', '$nisn', '$nama', '$kelas', '$rombel', '$jk'");
				endfor;
